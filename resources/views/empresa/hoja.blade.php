...
<div class="row" ng-controller="EmpHojaCtrl" ng-init="idEstudiante={{$idEstudiante}}">
                        ...
                        <md-content class="md-padding">
                            ...
                            <fieldset>
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group row" ng-if="hoja.estudiante.gettipo.nombre == 'Egresado'">
                                        <label class="control-label col-lg-3">Profesión</label>
                                        <label class="col-lg-9 nobolder">
                                            @{{ estudiante.getprograma.nombre | uppercase }}
                                        </label>
                                    </div>
