...
<div class="row" ng-controller="AdminVerActasCtrl" ng-init="acta.id = {{ $acta->id }}">
            ...
            <form role="form" ng-submit="guardarActa()">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        @if($acta->certificado_arl != null)
                        <p>
                            <a href="/admin/certificadoarl/{{ $acta->id }}" target="_blank">Descargar certificado de ARL</a>
                        </p>
                        @else
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <p>
                            <a href="/admin/certificadosalud/{{ $acta->id }}" target="_blank">Descargar certificado de salud</a>
                        </p>
                    </div>
                </div>
                <div class="form-group row">
