...
<div class="row" ng-controller="AdminCharlasCtrl">
            ...
            <table  object-table
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <span class="glyphicon glyphicon-pencil blue" title="Editar horario" data-toggle="modal" data-target="#crearCharla"
                ...
                <div class="modal-body">
                    <form role="form">
                        <div class="form-group row">
                            <label class="col-md-12">Conferencia</label>
                            <ui-select ng-model="charla.getconferencia" class="col-md-12">
                                <ui-select-match>
                                    <span ng-bind="$select.selected.nombre"></span>
                                </ui-select-match>
                                <ui-select-choices repeat="item in (conferencias2 | filter: $select.search) track by item.id">
                                    <span ng-bind="item.nombre"></span>
                                </ui-select-choices>
                            </ui-select>
                            <p class="help-block text-danger col-md-12">
                                @{{ errores['getconferencia.id'][0] }}
                            </p>
                        </div>
                        <fieldset class="row">
                            <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div style="position:relative; width:276px; margin:0 auto;">
                            <img src="@{{ raiz }}/img/fondo-rojo.png" style="width:@{{(charla.valoracion/5)*276 || 0 }}px; height:65px;"></img>
                            <div style="position:absolute; top:0; left:0;">
                                <img src="@{{ raiz }}/img/Estrellas.png"></img>    
                            </div>
                        </div>
                        <div class="row">
