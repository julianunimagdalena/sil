...
<div class="row" ng-controller="AdminCartasCtrl">
        ...
        <fieldset>
            ...
            <table  object-table
                ...
                <tbody>
                    ...
                    <td>
                        @{{ ::item.getempresa.getsedes[0].getmunicipio.nombre | uppercase }}
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <span data-id="@{{ ::item.id }}" class="glyphicon glyphicon-pencil pointer blue"
                            ...
                            ng-show="item.getestado.nombre=='Esperando respuesta'"></span>
