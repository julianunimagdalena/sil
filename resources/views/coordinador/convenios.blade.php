...
<div class="row" ng-controller="CdnConveniosCtrl">
    ...
    <div class="col-md-10">
        ...
        <table  object-table
            ...
            <tbody>
                ...
                <td>
                    <a href="/cdn/certificadoexistencia/@{{::item.id}}" ng-show="item.certificado_existencia != null" target="_blank">
                        Certificado de existencia
                        <br>
                    </a>
                    
                    <a href="/cdn/cedula/@{{::item.id}}" ng-show="item.cedula_representante != null" target="_blank">
                        Cédula del representante legal
                        <br>
                    </a>
                    <a href="/cdn/procuraduria/@{{::item.id}}" ng-show="item.procuraduria != null" target="_blank">
                        Certificado procuraduría
                        <br>
                    </a>
                    <a href="/cdn/contraloria/@{{::item.id}}" ng-show="item.contraloria != null" target="_blank">
                        Certificado contraloría
                        <br>
                    </a>
                    <a href="/cdn/rut/@{{::item.id}}" ng-show="item.rut != null" target="_blank">
                        Rut
                        <br>
                    </a>
                    <a href="/cdn/actaposesion/@{{::item.id}}" ng-show="item.acta_posesion != null" target="_blank">
                        Acta de posesión
                        <br>
                    </a>
                    <a href="/cdn/actoadministrativo/@{{::item.id}}" ng-show="item.acto_administrativo != null" target="_blank">
                        Acto administrativo
                        <br>
                    </a>
                    <a href="/cdn/militar/@{{::item.id}}" ng-show="item.certificado_militar != null" target="_blank">
                        Certificado situación militar
                        <br>
                    </a>
                    <a href="/cdn/fileconvenio/@{{::item.id}}" ng-show="item.convenio != null" target="_blank">
                        Convenio
                        <br>
                    </a>
                    <a href="/cdn/actarenovacion/@{{::item.id}}" ng-show="item.getactasrenovacion != null && item.getactasrenovacion.length > 0" target="_blank">
                        Acta de renovación
                    </a>
                </td>
                <td>
