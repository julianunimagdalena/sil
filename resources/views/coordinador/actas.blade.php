...
<div class="row" ng-controller="CdnActasCtrl">
    ...
    <div class="col-md-10">
        ...
        <fieldset>
            ...
            <table  object-table
            	data = "actas"
            	display = "10"
            	headers = "Código, Nombres, Apellidos,Programa,Modalidad,Empresa,  Acciones"
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <a href="/cdn/veracta/@{{ ::item.id }}" ng-show="item.getmodalidad.nombre == 'Vinculación laboral'" >
                            <span class="glyphicon glyphicon-search pointer" title="Ver acta"></span>
                        </a>
                        <span class="glyphicon glyphicon-search blue pointer" title="Ver documentos" ng-show="item.getmodalidad.nombre != 'Vinculación laboral'"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <a href="/cdn/cartasolicitud/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_carta_solicitud != null" target="_blank">
                        Carta de solicitud de practicas
                        <br>
                    </a>
                    
                    <a href="/cdn/certificadolaboral/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Validación' && estudiante.getpracticas[estudiante.getpracticas.length - 1].file_certificado_laboral != null" target="_blank">
                        Certificado laboral
                        <br>
                    </a>
                    
                    <a href="/cdn/certificadoexistenciaprac/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" 
                    ...
                    <a href="/cdn/certificadoss/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" 
                    ng-if="(estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Validación'
                            || estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Prácticas de empresarismo')
                    ...
                    <a href="/cdn/contrato/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Validación' && estudiante.getpracticas[estudiante.getpracticas.length - 1].file_certificado_laboral != null" target="_blank">
                        Contrato de prestación de servicios
                        <br>
                    </a>
                    
                    <a href="/cdn/cartacolaboracion/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" 
                    ...
                    <a href="/cdn/cedularelegal/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" 
                    ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Asesorías pymes'
                    ...
                    <div ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].getmodalidad.nombre == 'Prácticas internacionales'
                        ...
                        <a href="/cdn/cartadirector/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                        ...
                        <a href="/cdn/formatomovilidad/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_formato_movilidad != null">
                            Formato de movilidad
                            <br>
                        </a>
                        <a href="/cdn/pasaporte/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_pasaporte != null">
                            Pasaporte
                            <br>
                        </a>
                        <a href="/cdn/visa/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_visa != null">
                            Visa
                            <br>
                        </a>
                        <a href="/cdn/cedulaestudiante/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_cedula != null">
                            Cédula del estudiante
                            <br>
                        </a>
                        <a href="/cdn/carnet/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_carnet != null">
                            Carnet estudiantil
                            <br>
                        </a>
                        <a href="/cdn/padres/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_padres != null">
                            Extrajuicio de los padres
                            <br>
                        </a>
                        <a href="/cdn/extraestudiante/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_estudiante != null">
                            Extrajuicio del estudiante
                            <br>
                        </a>
                        <a href="/cdn/itinerario/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
                            ng-if="estudiante.getpracticas[estudiante.getpracticas.length - 1].file_itinerario != null">
                            Itinerario de vuelo
                            <br>
                        </a>
                        <a href="/cdn/seguro/@{{estudiante.getpracticas[estudiante.getpracticas.length - 1].id}}" target="_blank"
